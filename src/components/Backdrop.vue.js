...
__VLS_asFunctionalElement(__VLS_intrinsicElements.section, __VLS_intrinsicElements.section)(__assign({ class: "min-h-screen relative py-80" }, { id: "background" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "space-y-12 max-w-7xl mx-auto" }, { 'data-speed': "0.7", 'data-lag': "0.1", id: "images-container" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "flex gap-12 h-1/2" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "w-1/3" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.img)(__assign({ src: "/src/images/bonsai-1.jpg", alt: "Bonsai 1" }, { class: "w-full h-full object-cover shadow-lg" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "w-2/3" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.img)(__assign({ src: "/src/images/bonsai-8.png", alt: "Bonsai 2" }, { class: "w-full h-full object-cover shadow-lg" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "flex gap-12 h-1/2" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "w-2/3" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.img)(__assign({ src: "/src/images/bonsai-3.jpg", alt: "Bonsai 3" }, { class: "w-full h-full object-cover shadow-lg" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "w-1/3" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.img)(__assign({ src: "/src/images/bonsai-4.png", alt: "Bonsai 4" }, { class: "w-full h-full object-cover shadow-lg" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "flex gap-12 h-1/2" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "w-1/3" }));
...
/** @type {__VLS_StyleScopedClasses['py-80']} */ ;
